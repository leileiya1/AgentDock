...
export const qk = {
  ...
  databaseBackups: ["databaseBackups"] as const,
  trash: ["trash"] as const,
  projectSettings: (projectId: string) => ["projectSettings", projectId] as const,
  projectGitCompatibility: (projectId: string) => ["projectGitCompatibility", projectId] as const,
  projectConfigTrust: (projectId: string) => ["projectConfigTrust", projectId] as const,
