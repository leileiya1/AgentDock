...
export const qk = {
  ...
  queue: (taskId: string) => ["queue", taskId] as const,
  ...
  rollbackPreflight: (taskId: string) => ["rollbackPreflight", taskId] as const,
  planReview: (taskId: string) => ["planReview", taskId] as const,
  executionNodes: ["executionNodes"] as const,
  permissionRequests: (taskId: string) => ["permissionRequests", taskId] as const,
  permissionRules: (projectId: string) => ["permissionRules", projectId] as const,
};
